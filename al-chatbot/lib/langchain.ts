...
- If the answer is not found in the context, consider whether the question might belong to a different science subject (Biology, Physics, or Chemistry).
  ...
  - If it is a {subject} question but just not covered, respond ONLY with:
...
- Do NOT accept wrong Latin binomial names with any minor capitalisation or italics errors.
...
- UNIT RULE: If the question requires a numerical answer AND the student's answer does not include
  ...
  the numerical value is correct. Add a breakdown entry whose point is "Unit missing", awarded is 0,
  and comment is "No unit was stated. In Physics, a numerical answer without a unit scores zero."
...
- UNIT RULE: If the question requires a numerical answer AND the student's answer does not include
  ...
  whether the numerical value is correct. Add a breakdown entry whose point is "Unit missing", awarded is 0,
  and comment is "No unit was stated. In Chemistry, a numerical answer without a unit scores zero."
- If the question is purely qualitative (no numerical answer expected), the unit rule does not apply.
